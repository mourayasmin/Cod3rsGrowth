sap.ui.define([
    ...
    "./pages/Marca"
], function (opaQunit, Marca, JornadaListaMarca) { 
    "use strict";
...
QUnit.module("AdicionarMarcas", () => {
    ...
    opaTest("Deve adicionar uma marca com dados corretos", function(Given, When, Then){
     ...
     opaTest("Deve exibir uma mensagem de erro ao tentar salvar uma marca com campos vazios", function(Given, When, Then){
          When.naPaginaAdicionarMarca.oBotaoSalvarDeveSerPressionado();
          Then.naPaginaAdicionarMarca.aMensagemDeErroDeveSerExibidaEFechada();
          Then.naPaginaAdicionarMarca.oBotaoVoltarDeveSerPressionado();
          Then.naPaginaInicial.aTelaAdicionarMarcaDeveSerCarregadaCorretamente();
          Then.iTeardownMyApp();
         })
})
})
